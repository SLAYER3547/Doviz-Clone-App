                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  Text(fuelSellerList[index].fuelSellerName,
                                  ...
                                  children: [
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "₺${fuelSellerList[index].gasolinePrice.toString()}",
                                          style: const TextStyle(
                                              color: Colors.white),
                                        )
                                      ],
                                  ...
                                  children: [
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "₺${fuelSellerList[index].dieselPrice.toString()}",
                                          style: const TextStyle(
                                              color: Colors.white),
                                        )
                                      ],
                                  ...
                                  children: [
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "₺${fuelSellerList[index].lpgPrice.toString()}",
                                          style: const TextStyle(
                                              color: Colors.white),
                                        )
                                      ],
                            ...
                            Column(
                              ...
                              children: [
                                Text(
                                  ...
                                  style: const TextStyle(
                                      color: Color(0xFF86909b), fontSize: 12),
                                ),
                                SizedBox(
                                  width: MediaQuery.of(context).size.width /
                                      10 *
                                ...
                                Text(
                                  ...
                                  style: const TextStyle(
                                      color: Color(0xFFcaccd1), fontSize: 12),
                                )
                              ],
                            ),
                          ],
