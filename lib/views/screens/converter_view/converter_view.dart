...
import 'package:doviz_clone_app/views/screens/converter_view/currency_category_menu.dart';
import 'package:doviz_clone_app/views/screens/converter_view/edit_currency_list_page.dart';
...
class _CurrencyConverterPageState extends State<CurrencyConverterPage> {
  ...
  List<Currency> displayedCurrencies = List.from(currencies);
  ...
  void openAddCurrencyMenu() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => CurrencyCategoryMenu(
                          ...
                          child: TextField(
                            ...
                            onChanged: (value) {
                              if (value.isEmpty) {
                                amountControllers[currency.currencyName]?.text =
                                    '0';
                                updateAllCurrencies(currency.currencyName, 0);
                              } else {
