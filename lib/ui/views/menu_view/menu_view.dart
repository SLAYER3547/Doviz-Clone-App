import 'package:doviz_clone_app/core/models/menu_models/other_menu_pages_model.dart';
import 'package:doviz_clone_app/core/models/menu_models/pages_model.dart';
import 'package:doviz_clone_app/core/models/menu_models/settings_pages_model.dart';
...
import 'package:doviz_clone_app/ui/views/menu_view/no_ad_view.dart';
                ...
                GestureDetector(
                  onTap: () {
                    ...
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) =>const NoAdView()),);
                  },
                  child: Container(
                  ...
                  children: [
                    ListTile(
                      onTap: () {
                        _navigateToPage(
                          context,
                          settingsPagesList[index].targetPage,
                        );
                      },
                  ...
                  children: [
                    ListTile(
                      onTap: () {
                        _navigateToPage(
                          context,
                          otherMenuPagesList[index].targetPage,
                        );
                      },
                      title: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
