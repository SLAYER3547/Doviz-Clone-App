...
class MostActiveCryptoListOfDayPage extends StatefulWidget {
  const MostActiveCryptoListOfDayPage({super.key});

  @override
  State<MostActiveCryptoListOfDayPage> createState() =>
      _MostSavedCryptoListOfDayState();
}

class _MostSavedCryptoListOfDayState
    extends State<MostActiveCryptoListOfDayPage> {
        ...
        slivers: [
          ...
          SliverList(
            delegate: SliverChildBuilderDelegate(
                        ...
                        title: Row(
                          ...
                          children: [
                              ...
                              children: [
                                ...
                                SizedBox(
                                  width: MediaQuery.of(context).size.width /
                                      ...
                                      5,
                                  child: Text(
                                    mostActiveCryptoList[index].cryptoName,
                                    style: const TextStyle(
                            ...
                            Column(
                              children: [
                                Text(
                                  '\$${mostActiveCryptoList[index].price}',
                                  style: const TextStyle(
                                    color: defaultTextColor,
                                    fontSize: 18,
                                    fontWeight: FontWeight.w700,
                                ...
                                Row(
                                  children: [
                                    Text(
                                      '\$${mostActiveCryptoList[index].changedValueOfDay}',
                                      style: const TextStyle(
                                    ...
                                    Text(
                                      '%${mostActiveCryptoList[index].changedValuePercentageOfDay}',
                                      style: const TextStyle(
                                          color: Colors.green, fontSize: 12,),
                                    ),
                                  ],
              ...
              childCount: mostActiveCryptoList.length,
            ),
          ),
        ],
      ),
