...
class RisingExchangesListOfWeek extends StatefulWidget {
  const RisingExchangesListOfWeek({super.key});

  @override
  State<RisingExchangesListOfWeek> createState() => _RisingExchangesListOfWeekState();
}

class _RisingExchangesListOfWeekState extends State<RisingExchangesListOfWeek> {
  ...
  final risingExchangesListOfWeek = risingExchangesOfWeek;
  @override
        ...
        slivers: [
          ...
          SliverList(
            delegate: SliverChildBuilderDelegate(
                        ...
                        title: Row(
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                Text(
                                  risingExchangesListOfWeek[index].currencySymbolName,
                                ...
                                SizedBox(
                                  width: MediaQuery.of(context).size.width /
                                      ...
                                      5,
                                  child: Text(
                                    risingExchangesListOfWeek[index].currencyName,
                                    style: const TextStyle(
                            ...
                            Column(
                              children: [
                                Text(
                                  '\$${risingExchangesListOfWeek[index].sellPrice}',
                                  style: const TextStyle(
                                      color: defaultTextColor,
                                      fontSize: 18,
                                      fontWeight: FontWeight.w700,),
                                ...
                                Row(
                                  children: [
                                    Text(
                                      '\$${risingExchangesListOfWeek[index].changedValueOfDay}',
                                      style:
                                    ...
                                    Text(
                                      '%${risingExchangesListOfWeek[index].changedPercentageOfDay}',
                                      style:
                                          const TextStyle(color: Colors.green),
                                    ),
                                  ],
              ...
              childCount: risingExchangesListOfWeek.length,
            ),
          ),
        ],
      ),
