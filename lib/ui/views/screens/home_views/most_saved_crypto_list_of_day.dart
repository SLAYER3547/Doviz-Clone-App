...
class MostSavedCryptoListOfDayPage extends StatefulWidget {
  const MostSavedCryptoListOfDayPage({super.key});

  @override
  State<MostSavedCryptoListOfDayPage> createState() =>
      _MostSavedCryptoListOfDayState();
}

class _MostSavedCryptoListOfDayState
    extends State<MostSavedCryptoListOfDayPage> {
        ...
        slivers: [
          ...
          SliverList(
            delegate: SliverChildBuilderDelegate(
                        ...
                        title: Row(
                          ...
                          children: [
                              ...
                              children: [
                                ...
                                SizedBox(
                                  width: MediaQuery.of(context).size.width /
                                      ...
                                      5,
                                  child: Text(
                                    mostSavedCryptoList[index].cryptoName,
                                    style: const TextStyle(
                            ...
                            Column(
                              children: [
                                Text(
                                  '\$${mostSavedCryptoList[index].price}',
                                  style: const TextStyle(
                                    color: defaultTextColor,
                                    fontSize: 18,
                                    fontWeight: FontWeight.w700,
                                ...
                                Row(
                                  children: [
                                    Text(
                                      '\$${mostSavedCryptoList[index].changedValueOfDay}',
                                      style:
                                    ...
                                    Text(
                                      '%${mostSavedCryptoList[index].changedValuePercentageOfDay}',
                                      style:
                                          const TextStyle(color: Colors.green,fontSize: 12),
              ...
              childCount: mostSavedCryptoList.length,
            ),
          ),
        ],
      ),
