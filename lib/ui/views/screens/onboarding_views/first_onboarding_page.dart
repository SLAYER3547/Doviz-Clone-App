...
import 'package:doviz_clone_app/ui/components/onboarding_currency_list.dart';
    ...
    return Column(
      children: [
        ...
        const Text(
          ...
          style: TextStyle(color: defaultTextColor, fontSize: 30),
        ),
        const SizedBox(
          height: 15,
        ),
        const Text(
          ...
          style: TextStyle(color: systemGreyColor, fontSize: 20),
