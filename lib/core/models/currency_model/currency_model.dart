...
class Currency {
  ...
  factory Currency.fromJson(Map<String, dynamic> json) {
    return Currency(
      ...
      currencyCategory: _currencyCategoryFromString(json['currencyCategory'].toString()),
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'currencyCategory': currencyCategory.toString().split('.').last, // Enum'u string'e çevir
      'buyPrice': buyPrice,
      'sellPrice': sellPrice,
      'lastPrice': lastPrice,
